...
int main()
{
	...
	int size = sizeof(random) / sizeof(random) - 1;
	srand(time(NULL));
	for (int i = 0; i < 100000000; i++) random[i] = rand() % 100000000 + 1;
	int* low = random, *high = low + sizeof(random) / sizeof(random[0]) - 1;
